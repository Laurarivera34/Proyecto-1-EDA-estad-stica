...
3) Personas con discapacidad (esta no se agrega al índice porque solo hay un hogar que tiene persona condiscapacidad)
...
hogares_vulnerabilidad <- hogares_out %>%
  ...
  mutate(
    ...
    # ⚠️ Nuevo índice SIN discapacidad
...
```{r}
# B. CÁLCULO DE FRECUENCIAS PONDERADAS Y EXPORTACIÓN - INDICE DE VULNERABILIDAD (X)
